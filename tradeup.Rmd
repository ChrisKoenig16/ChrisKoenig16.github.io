...
Calculating all possible tradeups is not exactly efficient or really necessary so i instead limit this project in certain ways to make the process much faster and simpler.
